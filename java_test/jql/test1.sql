...
-- ----------------------------
INSERT INTO `tb_department` VALUES ('1', '物资管理部', '15045741241', '负责系统物资的管理。', '2020-03-16 00:00:00', '2020-05-16 11:47:28', '71');
...
-- Records of tb_menu
-- ----------------------------
INSERT INTO `tb_menu` VALUES ('1', '0', '欢迎页面', '/welcome', 'welcome:view', 'el-icon-star-off', '0', '1', '2020-03-10 08:46:44', '2020-04-15 20:49:47', '1', '0');
...
INSERT INTO `tb_menu` VALUES ('319', '2', '公告管理', '/notices', '', 'el-icon-s-flag', '0', '4', '2020-04-21 12:07:46', '2020-05-05 19:55:08', '0', '0');
...
-- Records of tb_role
-- ----------------------------
INSERT INTO `tb_role` VALUES ('0', 'admin33', '拥有系统的最高权限.', '2019-06-14 00:00:00', '2020-04-27 21:29:29', '0');
...
CREATE TABLE `tb_user` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=265 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户表';

-- ----------------------------
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES ('5', 'liao', 't3t', 't43t3', '', 't43t', '1', '2019-06-14 21:12:16', '2020-10-26 15:51:18', '0', 'E46E184B-BAE5-4EE0-B3D9-674A04F37DDE', '0', 't34t', '2020-03-18', '12', '0');
...
INSERT INTO `tb_user` VALUES ('56', 'coderman', 'zhangyu', 'zhangyukang@qq.com', 'http://badidol.com/uploads/images/avatars/201910/24/18_1571921832_HG9E55x9NY.jpg', '13426528317', '1', '2020-03-08 10:33:00', '2020-04-04 19:57:35', '1', '37eb6e49-8ead-404f-9325-93fc9507', '1', '5bf3d15435f5d970292d28f44d0cde1a', '2020-03-20', '1', '0');
...
INSERT INTO `tb_user_role` VALUES ('5', '77');
INSERT INTO `tb_user_role` VALUES ('5', '78');
INSERT INTO `tb_user_role` VALUES ('5', '79');
INSERT INTO `tb_user_role` VALUES ('5', '80');
INSERT INTO `tb_user_role` VALUES ('5', '125');
INSERT INTO `tb_user_role` VALUES ('5', '126');
INSERT INTO `tb_user_role` VALUES ('5', '127');
INSERT INTO `tb_user_role` VALUES ('5', '128');
INSERT INTO `tb_user_role` VALUES ('5', '135');
INSERT INTO `tb_user_role` VALUES ('5', '136');
INSERT INTO `tb_user_role` VALUES ('5', '137');
INSERT INTO `tb_user_role` VALUES ('5', '138');
INSERT INTO `tb_user_role` VALUES ('5', '139');
INSERT INTO `tb_user_role` VALUES ('5', '140');
INSERT INTO `tb_user_role` VALUES ('5', '141');
INSERT INTO `tb_user_role` VALUES ('5', '143');
